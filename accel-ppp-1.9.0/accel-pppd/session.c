...
//	write_to_file(1, ses->ipv4_pool_name, 0, "/var/log/accel-ppp/Disconn");
...
{
	log_emerg("User is connected . . ");
	write_to_file(1, ses->ipv4_pool_name, 0, "/var/log/accel-ppp/Connected-Users");
...
void __export ap_session_terminate(struct ap_session *ses, int cause, int hard)
{
	...
	write_to_file(1, ses->ipv4_pool_name, 0, "/var/log/accel-ppp/Disconnected");
